...
if torch.cuda.device_count() > 1:
    ...
    # This line is the only change you need to parallelize your model!
...
if i % SAVE_EVERY == 0:
    ...
    fname = os.path.join(dataset_addr, 'model_checkpoint_' + str(i) + '_steps_' + str(round(float(train_losses[-1]), 4)) + '_loss.pth')
    
    torch.save(model.state_dict(), fname)
    
    data = [train_losses, train_accs, val_losses, val_accs]

    TMIDIX.Tegridy_Any_Pickle_File_Writer(data, os.path.join(dataset_addr, 'losses_accs'))
...
plt.savefig(os.path.join(dataset_addr, 'training_loss_graph.png'))
plt.close()
print('Done!')
...
plt.savefig(os.path.join(dataset_addr, 'training_acc_graph.png'))
plt.close()
print('Done!')
...
plt.savefig(os.path.join(dataset_addr, 'validation_loss_graph.png'))
plt.close()
print('Done!')
...
plt.savefig(os.path.join(dataset_addr, 'validation_acc_graph.png'))
plt.close()
print('Done!')
...
if len(out) != 0:
    ...
    detailed_stats = TMIDIX.Tegridy_SONG_to_MIDI_Converter(song_f,
                                                        ...
                                                        output_file_name = os.path.join(dataset_addr, 'Perceiver-Music-Transformer-Music-Composition'),
