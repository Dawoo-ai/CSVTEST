...
dataset_addr = os.path.join(current_directory, 'MODEL')

"""# (LOAD MODEL)"""

#@title Load/Reload the model

full_path_to_model_checkpoint = os.path.join(dataset_addr,"model_checkpoint_7966_steps_1.3398_loss.pth") #@param {type:"string"}
...
full_path_to_custom_MIDI_file = os.path.join(dataset_addr,"seed5.mid") #@param {type:"string"}
...
if len(out1) != 0:
    ...
    detailed_stats = TMIDIX.Tegridy_SONG_to_MIDI_Converter(song_f,
                                                        ...
                                                        output_file_name = os.path.join(dataset_addr,"Perceiver-Music-Transformer-seed-MIDITEST5"),
...
# fname = '/home/dxwoo/Documents/Code_2/Perceiver-Music-Transformer/SEEDS/'
...
for i in range(number_of_batches_to_generate):
  ...
  if len(out1) != 0:
      ...
      detailed_stats = TMIDIX.Tegridy_SONG_to_MIDI_Converter(song_f,
                                                          output_signature = 'Perceiver Music Transformer',  
                                                          output_file_name = os.path.join(dataset_addr,"Perceiver-Music-Transformer-seed-Composition5"), 
                                                          track_name='Project Los Angeles',
                                                          list_of_MIDI_patches=[0, 24, 32, 40, 42, 46, 56, 71, 73, 0, 53, 19, 0, 0, 0, 0],
                                                          number_of_ticks_per_quarter=500)
  ...
  print('Displaying resulting composition...')
  # fname = '/workspace/Perceiver-Music-Transformer-Composition'
